...
# the standard knn function is used for training/testing
# implemented the cross validation section
# divided the training data into 'numFolds' folds, such that one fold for validation, others for training
